...
def sync_phase2_schema() -> None:
    ...
    statements = [
        ...
        *_audit_schema_statements(),
        ...
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS chain_key VARCHAR(255)",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS stable_fingerprint VARCHAR(64)",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS title VARCHAR(255)",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS classification VARCHAR(40) DEFAULT 'suspicious'",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS risk_score INTEGER DEFAULT 0",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS confidence INTEGER DEFAULT 0",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS status VARCHAR(40) DEFAULT 'open'",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS source_type VARCHAR(40)",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS source_value VARCHAR(255)",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS stage_count INTEGER DEFAULT 0",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS event_count INTEGER DEFAULT 0",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS alert_count INTEGER DEFAULT 0",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS first_seen TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS last_seen TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS mitre_techniques JSON",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS mitre_tactics JSON",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS related_assets JSON",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS related_users JSON",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS related_iocs JSON",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS summary TEXT",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS version INTEGER DEFAULT 1",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT now() NOT NULL",
        "ALTER TABLE attack_chains ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",
        ...
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS attack_chain_id INTEGER",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS step_index INTEGER",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS timestamp TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS stage VARCHAR(120)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS event_type VARCHAR(120)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS severity VARCHAR(40)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS mitre_technique VARCHAR(160)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS mitre_tactic VARCHAR(120)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS hostname VARCHAR(255)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS username VARCHAR(120)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS source_ip VARCHAR(64)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS destination_ip VARCHAR(64)",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS event_id INTEGER",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS alert_id INTEGER",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS description TEXT",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS confidence INTEGER",
        "ALTER TABLE attack_chain_steps ADD COLUMN IF NOT EXISTS metadata JSON",
        ...
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS campaign_key VARCHAR(255)",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS stable_fingerprint VARCHAR(64)",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS title VARCHAR(255)",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS classification VARCHAR(40) DEFAULT 'suspicious'",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS risk_score INTEGER DEFAULT 0",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS chain_count INTEGER DEFAULT 0",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS shared_iocs JSON",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS shared_source_ips JSON",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS shared_assets JSON",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS shared_users JSON",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS shared_techniques JSON",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS first_seen TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS last_seen TIMESTAMP WITH TIME ZONE",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS summary TEXT",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT now() NOT NULL",
        "ALTER TABLE campaign_clusters ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",
        ...
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS attack_chain_id INTEGER",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS campaign_cluster_id INTEGER",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS title VARCHAR(255)",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS assigned_to VARCHAR(120)",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS status VARCHAR(40) DEFAULT 'open'",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS priority VARCHAR(40)",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS analyst_notes TEXT",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS evidence_refs JSON",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT now() NOT NULL",
        "ALTER TABLE investigation_sessions ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE",
...
def _session_security_schema_statements() -> list[str]:
    """Return additive schema statements for session governance."""
    return [
        "CREATE TABLE IF NOT EXISTS login_attempts (id SERIAL PRIMARY KEY, email_or_username VARCHAR(120) NOT NULL, ip_address VARCHAR(64), user_agent VARCHAR(500), outcome VARCHAR(40) NOT NULL DEFAULT 'failure', reason VARCHAR(255), created_at TIMESTAMP WITH TIME ZONE DEFAULT now() NOT NULL)",
        "ALTER TABLE login_attempts ADD COLUMN IF NOT EXISTS email_or_username VARCHAR(120)",
        "ALTER TABLE login_attempts ADD COLUMN IF NOT EXISTS ip_address VARCHAR(64)",
        "ALTER TABLE login_attempts ADD COLUMN IF NOT EXISTS user_agent VARCHAR(500)",
        "ALTER TABLE login_attempts ADD COLUMN IF NOT EXISTS outcome VARCHAR(40) DEFAULT 'failure'",
        "ALTER TABLE login_attempts ADD COLUMN IF NOT EXISTS reason VARCHAR(255)",
        "ALTER TABLE login_attempts ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT now() NOT NULL",
        "UPDATE login_attempts SET email_or_username = 'unknown' WHERE email_or_username IS NULL OR email_or_username = ''",
        "UPDATE login_attempts SET outcome = 'failure' WHERE outcome IS NULL OR outcome = ''",
        "CREATE INDEX IF NOT EXISTS ix_login_attempts_identity_time ON login_attempts (email_or_username, created_at)",
        "CREATE INDEX IF NOT EXISTS ix_login_attempts_ip_time ON login_attempts (ip_address, created_at)",
        "CREATE INDEX IF NOT EXISTS ix_login_attempts_outcome ON login_attempts (outcome)",
        "CREATE TABLE IF NOT EXISTS user_sessions (id SERIAL PRIMARY KEY, user_id INTEGER NOT NULL, token_jti VARCHAR(120) NOT NULL UNIQUE, created_at TIMESTAMP WITH TIME ZONE DEFAULT now() NOT NULL, last_seen_at TIMESTAMP WITH TIME ZONE, expires_at TIMESTAMP WITH TIME ZONE NOT NULL, revoked_at TIMESTAMP WITH TIME ZONE, revoked_reason VARCHAR(255), ip_address VARCHAR(64), user_agent VARCHAR(500), is_active BOOLEAN NOT NULL DEFAULT true)",
        "ALTER TABLE user_sessions ADD COLUMN IF NOT EXISTS user_id INTEGER",
        "ALTER TABLE user_sessions ADD COLUMN IF NOT EXISTS token_jti VARCHAR(120)",
        ...
        "ALTER TABLE user_sessions ADD COLUMN IF NOT EXISTS revoked_reason VARCHAR(255)",
